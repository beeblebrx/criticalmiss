...
This game uses SFML 2.6.2 for window management, 2D graphics, keyboard events and sounds.
...
Conform to Clean Architecture principles: focus on creating software that is flexible, maintainable, and testable by separating concerns into distinct layers. 
